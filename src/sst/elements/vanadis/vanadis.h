...
public:
    ...
    { "reorder_slots", "Number of slots in the reorder buffer", "64"},
        ...
        { "integer_div_w_cycles", "Latency of a 32-bit (W-form) integer divide or remainder; 0 = integer_div_cycles", "0" },
        { "integer_div_w_interval", "Cycles an integer divider is held by a W-form divide or remainder; 0 = 1 (fully pipelined)", "0" },
        { "integer_div_x_cycles", "Latency of a 64-bit (X-form) integer divide or remainder; 0 = integer_div_cycles", "0" },
        { "integer_div_x_interval", "Cycles an integer divider is held by an X-form divide or remainder; 0 = 1 (fully pipelined)", "0" },
